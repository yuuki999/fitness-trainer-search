...
INSERT INTO trainers (name, profile_img, profile, followers, engagement_rate, area) VALUES
('佐藤 美咲', 'https://randomuser.me/api/portraits/women/1.jpg', 'ヨガインストラクター / パーソナルトレーナー / 食事管理士', 12500, 3.2, '東京'),
('田中 愛子', 'https://randomuser.me/api/portraits/women/2.jpg', 'ピラティスインストラクター / ダイエットコーチ / 栄養士', 8700, 4.5, '大阪'),
('鈴木 香織', 'https://randomuser.me/api/portraits/women/3.jpg', '筋トレスペシャリスト / ボディメイクトレーナー', 15300, 2.8, '福岡'),
('山田 千尋', 'https://randomuser.me/api/portraits/women/4.jpg', 'ダンスインストラクター / フィットネスモデル', 25800, 5.1, '名古屋'),
('伊藤 理恵', 'https://randomuser.me/api/portraits/women/5.jpg', 'パーソナルトレーナー / 食事管理士', 7800, 3.7, '札幌');
